...
meals_indices['by_date'] = defaultdict(dict)



#meals_indices = { d : [] for d in some_set_of_dates }
#  meals_indices['2020-05-20'].append( "meal": {"Lunch": {"recipe_id": 23 }} )


for data_meal in data_meals:
  #meal_date = datetime.utcfromtimestamp(int(data_meal['meal_date_ts'])).strftime('%Y-%m-%d')
  ...
  meals_indices['by_date'][meal_date] = defaultdict(dict)
  meals_indices['by_date'][meal_date]['meal'] = defaultdict(dict)
  #meals_indices['by_date'][meal_date]['meal'][meal_type_name] = defaultdict(dict)
  meals_indices['by_date'][meal_date]['meal'][meal_type_name]['recipe_id'] = data_meal['recipe_id']
  meals_indices['by_date'][meal_date]['meal'][meal_type_name]['recipe_filename'] = meal_recipe_filename
  meals_indices['by_date'][meal_date]['meal'][meal_type_name]['recipe_name'] = data_meal['recipe_name']

  #meals_indices['by_date'] = {
  #  meal_date: {
  #      'meal': { 
  #         meal_type_name: { 
  #        'meal_recipe_id': data_meal['recipe_id'], 
  #        'meal_recipe_filename': meal_recipe_filename, 
...
# Meals Indices
json_data_meals_dump = json.dumps(data_meals, ensure_ascii=False, sort_keys=True, indent=2)
...
json_meals_indices_dump = json.dumps(meals_indices, ensure_ascii=False, sort_keys=True, indent=2)
